...
@Subselect("SELECT \n" +
        ...
        "record.id as record_id,record.operation_user_id as record_operation_user_id,record.operation_user_name as record_operation_user_name,record.created_time as record_operation_time,record.action as record_action,record.ext as record_ext,record,record.reason as record_reason\n" +
        "from wf_task task\n" +
        ...
        "left join wf_task_execute_history record on task.id = record.task_id")
